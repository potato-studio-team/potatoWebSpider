...
BrandingText "安装子雨网页爬虫"

Section "rootGroup" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite ifnewer
  File "PotatoWebSpider.exe"
  CreateDirectory "$SMPROGRAMS\子雨网页爬虫"
  CreateShortCut "$SMPROGRAMS\子雨网页爬虫\子雨网页爬虫.lnk" "$INSTDIR\PotatoWebSpider.exe"
  CreateShortCut "$DESKTOP\子雨网页爬虫.lnk" "$INSTDIR\PotatoWebSpider.exe"
  File "about.txt"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\子雨网页爬虫\Website.lnk" "$INSTDIR\${PRODUCT_NAME}.url"
  CreateShortCut "$SMPROGRAMS\子雨网页爬虫\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\子雨网页爬虫\Uninstall.lnk"
  Delete "$SMPROGRAMS\子雨网页爬虫\Website.lnk"
  Delete "$DESKTOP\子雨网页爬虫.lnk"
  Delete "$SMPROGRAMS\子雨网页爬虫\子雨网页爬虫.lnk"

  RMDir "$SMPROGRAMS\子雨网页爬虫"
